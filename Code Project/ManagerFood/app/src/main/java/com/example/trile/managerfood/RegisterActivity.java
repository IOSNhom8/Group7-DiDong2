...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextAgain = (EditText) findViewById(R.id.edit_text_password_again);
    ...
    private void register() {
        ...
        }else if (!editTextAgain.getText().toString().equalsIgnoreCase(editTextPassword.getText().toString())) {
            Toast.makeText(this, "Mật khâu không trùng khớp", Toast.LENGTH_SHORT).show();
        } else {

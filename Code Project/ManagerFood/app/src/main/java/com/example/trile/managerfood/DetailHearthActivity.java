...
public class DetailHearthActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.detail_hearth);
    ...
    private void loadData() {
        ...
        mData.child("SPSucKhoe").addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                if (main.getName().equalsIgnoreCase(bundle.getString("suckhoe"))) {
                    Picasso.with(DetailHearthActivity.this).load(main.getImg()).into(img);
